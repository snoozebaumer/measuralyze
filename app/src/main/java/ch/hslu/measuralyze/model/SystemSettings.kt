...
data class SystemSettings(var isWifiScanningEnabled: Boolean = false, var isBluetoothScanningEnabled: Boolean = false, var isAirplaneModeEnabled: Boolean = false, var isWifiEnabled: Boolean = false, var isBluetoothEnabled: Boolean = false, var isSimPresent: Boolean = false) {
